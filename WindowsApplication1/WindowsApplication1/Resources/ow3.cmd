...
"%_ARMA2OAPATH%\ArmA2OA_BE.exe" 0 0 -nosplash -skipintro -noPause -world=empty "-mod=%_ARMA2PATH%;EXPANSION;ca;@DayzOverwatch" -connect=208.167.247.35 -port=4444 /high
